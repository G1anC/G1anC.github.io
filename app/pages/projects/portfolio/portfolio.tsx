		...
		<Project titleRef={titleRef} filterRef={filterRef} bgRef={bgRef} name={"portfolio"} childrens={[
			...
			<div className={"w-full flex justify-end items-center p-32"}>
				...
				<div className={"w-2/3 text-end "}>
					...
					Truly a <I>mess</I> but a <I>fun</I> one.
				</div>
			</div>,
			...
			<div className={"p-48 text-center"}>
				A bit better but <I>a lot</I> to learn.
			</div>,
			<div className={"w-full flex justify-start items-center p-32"}>
				<div className={"w-2/3 text-start"}>
					I never coded it because i knew i could design <I>something way better</I>.
				</div>
				<div className={"w-auto"}></div>
			</div>,
			...
			<div className={"w-full flex justify-end items-center p-32"}>
				<div className={"w-auto"}></div>
				<div className={"w-2/3 text-end "}>
					<I>3.</I><br /> At this point, i really wanted to do something that <I>fitted me better</I>.
					So i tried designing more <I>unique</I> ideas.
				</div>
			</div>,
			<div>
			...
			<div className={"p-48 text-center"}>
				I really liked this one, loved the <I>aesthetic</I> and the <I>logic</I>.
				<br/>
				<br/>
				<br/>
				<I>But.</I>
