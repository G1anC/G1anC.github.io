...
const FluidBack: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const material = new THREE.ShaderMaterial({
            uniforms: {
                ...
                resolution: { value: new THREE.Vector2(window.innerWidth / 200, window.innerHeight / 200) },
            },
            vertexShader: `
        ...
        const handleResize = () => {
            renderer.setSize(window.innerWidth, window.innerHeight);
            material.uniforms.resolution.value.set(window.innerWidth / 200, window.innerHeight / 200);
    ...
    return <div ref={containerRef} style={{ position: "absolute", top: 0, left: 0, width: "100%", height: "100%", opacity: "70%", zIndex: -1 }} />;
};
