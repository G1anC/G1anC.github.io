			...
			<div className="max-w-7xl bg-[#EBF0F8]/5 z-10 mx-auto min-h-screen py-16 relative">
				...
				<div className="w-full mt-16 flex-col flex h-full">
					<div className="w-full gap-16 flex">
						<div className="p-10 pt-12 w-88 shrink-0 backdrop-blur-xl border text-justify relative z-10 bg-[#EBF0F8]/33 border-black/33 rounded-lg">
							<div className="absolute px-6 top-0 -translate-1/2 left-1/2 backdrop-blur-xs bg-[#EBF0F8]">
						...
						<div className="p-10 pt-12 w-full backdrop-blur-sm border text-justify relative z-10 border-black/33 rounded-lg">
							<div className="absolute px-6 top-0 -translate-1/2 left-40 flex items-center gap-8 backdrop-blur-xl bg-[#EBF0F8]">
								<img src="/me1.png" alt="ASCII branch" className="w-16 pointer-events-none" />
								WEEKS TASKS
							</div>
							<ul>
